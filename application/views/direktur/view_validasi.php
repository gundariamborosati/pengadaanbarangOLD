<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="box box-default">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('c_progress/simpan_identifikasi')?>" method="post" class="form-horizontal">
                  <!-- no -->
                  <div class="form-group ">
                      <label for="no" class="col-md-3 control-label">no pesanan</label>
                      <div class="col-md-7 col-sm-12 required">
                        <input type="text" value="<?php echo $no_pesanan; ?>" class="form-control" name="no_pesanan" readonly required>
                      </div>
                  </div>
                  <!-- dari -->
                <!--   <div class="form-group ">
 ...
 -->                  <!-- tgl identifikasi -->
                 ...
                 <!--    <a class="btn btn-default" href="<?php echo base_url('per/identifikasi/'. $id_permintaan )?>"><i class="fa fa-close"></i> Batal</a> -->
