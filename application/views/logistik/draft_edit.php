<?php
foreach($mheader->result_array() as $row){
...
<main class="main">
   ...
   <div class="container-fluid">
      <div class="card card-accent-success">
         ...
         <div class="card-body">
			<form class="form-horizontal" method="post" action="<?php echo site_url('draft/update');?>">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10"> 
				  <input type="text" class="form-control" id="judul" name="judul" value="<?php echo $judul;?>" placeholder="Input Judul" required>
				</div>
			  </div>
			  <div class="form-group">
				<label class="control-label col-sm-2" for="deskripsi">DESKRIPSI</label>
				<div class="col-sm-10"> 
				  <textarea class="form-control" rows="3" id="deskripsi" name="deskripsi" placeholder="Input Deskripsi" required><?php echo $deskripsi;?></textarea>
				</div>
			  </div>
			  <div class="form-group"> 
